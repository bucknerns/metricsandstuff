define({ "api": [
  ...
  },
  {
    ...
    "group": "Attachments",
    "description": "<p>Get list of matches using one or more filters. Api call can return 3 possible match types: group dictionaries, group lists, or string matches. The call will attempt a literal_eval and a json.loads on the values of groups, if not sucessful it will return the string</p>",
    "parameter": {
      "fields": {
        "URL Variable": [
          {
        ...
        "Parameters": [
          {
            ...
            "optional": true,
            "field": "type",
            "description": "<p>Type of matching to perform, overrides of auto discovery</p>"
          }
        ],
        "Request Body": [
          {
            ...
            "optional": false,
            "field": "list",
            "description": "<p>List of filter names</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Response Body": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "match",
            "description": "<p>A string based on regex match</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "name": "GetFilter",
    "group": "Filters",
    "description": "<p>Get a Filter by name</p>",
    "parameter": {
      "fields": {
        "URL Variable": [
          {
  ...
  },
  {
    ...
    "name": "UpdateFilter",
    "group": "Filters",
    "description": "<p>Updates a filter</p>",
    "parameter": {
      "fields": {
        "Parameters": [
          {
      ...
      "fields": {
        "Response Body": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "metadata",
            "description": "<p>Dictionary containing metadata key value pairs. None nested data</p>"
          }
        ]
      },
      "examples": [
